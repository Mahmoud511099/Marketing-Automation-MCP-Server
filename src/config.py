...
class Config:
    ...
    def has_platform_credentials(self, platform: Any) -> bool:
        ...
        if isinstance(config, GoogleAdsConfig):
            ...
            return bool(config.property_id and (config.client_id or config.service_account_path))
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "database_url": self.database.url.split("@")[0] if "@" in self.database.url else self.database.url,
            "cache_enabled": self.performance.cache_enabled,
